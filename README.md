简悦 是一款简单免费的音乐播放器，写这个的原因呢，就是不想登录账号，简简单单的听听自己喜欢歌，而不是在有些平台听着听着自己喜欢的歌要么因为版权原因下架，要么就是开始收费了，要充会员（没办法，穷逼一个😂），也是因此在多个平台来回切换搜索，一两首还行，如果多了管理起来就麻烦了。自己写Flutter也有一段时间了，刚好最近公司的项目想在PC端重写一个，就想着用Flutter实现试一试，于是先拿这个项目来熟悉一下Flutter开发PC端，练练手，主要用于学习及个人使用，没有商业用途哈，还有很重要的一点：不支持收费音乐的播放哦。
